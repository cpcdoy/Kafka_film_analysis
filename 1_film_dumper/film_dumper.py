    ...
    while nb_movies > nb_dumped_movies:
        ...
        try:
            ...
            if (len(reviews["results"])):
                ...
                movie_list.append(Movie(i, movie.title, movie.release_date, movie.popularity, movie.revenue, movie.budget, genre_list, review_list, -1))

                #STING TO SEND !!!
                #Movie(i, movie.title, movie.release_date, movie.popularity, movie.revenue, movie.budget, genre_list, review_list, -1).__dict__
